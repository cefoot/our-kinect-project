...
namespace KinectRotater
{
    ...
    public class PrimitiveLine
    {
        ...
        /// <param name="clearVectors">remove all privius vectors ?</param>
        public void CreateCircle(float radius, int sides, bool clearVectors)
        {
            if (clearVectors) vectors.Clear();
        ...
        {
            CreateCircle(radius, sides, true);
        }
    }
}